...
-- doctors
INSERT INTO doctors (doctor_id, name, specialty, hospital_id, email)
VALUES
...
-- departments
INSERT INTO departments (department_id, hospital_id, name)
VALUES 
(1, 1, 'Cardiology'),
(2, 1, 'Radiology'),
(3, 1, 'Oncology'),
...
-- prescriptions
INSERT INTO prescriptions (prescription_id, patient_id, doctor_id, medication_id, prescribed_date)
VALUES 
...
-- rooms
INSERT INTO rooms (room_id, room_no, department_id, capacity)
VALUES 
(1, '101A', 3, 2),
(2, '101B', 3, 1),
(3, '102', 5, 2),
